...
function Programs() {
  const pic1 = 'https://tse1.mm.bing.net/th?id=OIP.Tgsg53kG24hYRzb0ihuQpwHaFC&pid=Api&P=0&w=247&h=168';
  const imgarr = [chess,cricket,poetry,sing,volleyball,camera,paint]
  return (
    <div className='prgms'>
